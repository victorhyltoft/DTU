...
public class PredatorPrayTeleport {
	...
	public static void runSimulation(int n, int s, int t) {
		...
		// Intitialize immutable objects (constants) to prevent accidential altering.
		...
		/*
		 * In case iteration = 0, the the loop won't run therefore we will have to check if positions match
		 */
	 ...
	 */
	private static boolean isMatchingPositions(int[] pray, int[] predator) {
		// Compare arrays
	 ...
	 * TODO  
	 */
	private static int[] movePray(int[] pray, int randomInt, final int minBorder, final int maxBorder) {
	 ...
	 */
	private static int[] movePredator(int[] predator, int[] pray, final int maxMoveLength) {
	 ...
	 * As long as the pray doesnt find a way to exit the Matrix (reference)
