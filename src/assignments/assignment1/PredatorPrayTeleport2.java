...
public class PredatorPrayTeleport2 {
     ...
     */
    private static void isInsideGrid(Point animal, final int grid) {
        ...
        // If it's outside the top of the grid it cannot also be outside the bottom (0), this is why
        // our if statements look like they do; for a small (probably negligible) performance improvements.
        if (animalX > grid) {
